    ...
    <footer className="bg-muted mt-auto">
      <div className="container py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">ShopJoy</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Making shopping joyful for customers and merchants alike.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/categories" className="text-muted-foreground hover:text-foreground transition">
                  Categories
                </Link>
              </li>
              <li>
                <Link to="/featured" className="text-muted-foreground hover:text-foreground transition">
                  Featured
                </Link>
              </li>
              <li>
                <Link to="/new-arrivals" className="text-muted-foreground hover:text-foreground transition">
                  New Arrivals
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/shipping" className="text-muted-foreground hover:text-foreground transition">
                  Shipping Policy
                </Link>
              </li>
              <li>
                <Link to="/returns" className="text-muted-foreground hover:text-foreground transition">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t text-center md:flex md:items-center md:justify-between">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} ShopJoy. All rights reserved.
          </p>
